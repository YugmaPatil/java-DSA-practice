...
// TreeMap is a part of Java's Collections Framework and implements the Map interface. It stores key-value pairs in a sorted order based on the 
// natural ordering of the keys or by a specified comparator. TreeMap does not allow null keys but allows null values. It provides log(n) time complexity for basic operations like get, put, and remove.
